...
import { j as joinRelativeURL, e as useRuntimeConfig, f as defineRenderHandler, g as getQuery, c as createError, h as getRouteRules, i as getResponseStatus, k as getResponseStatusText, l as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","href":"/favicons/favicon.ico"},{"rel":"apple-touch-icon","href":"/favicons/apple-touch-icon.png","sizes":"180x180"},{"rel":"mask-icon","href":"/favicons/logo.svg"}],"style":[],"script":[],"noscript":[]};
