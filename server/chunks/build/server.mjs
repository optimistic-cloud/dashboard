import { version, defineAsyncComponent, toRef as toRef$1, isRef, defineComponent, h, getCurrentInstance, inject, ref, watch, computed, toValue as toValue$1, reactive, unref, provide, shallowReactive, Suspense, nextTick, Fragment, Transition, useSSRContext, hasInjectionContext, watchEffect, getCurrentScope, onScopeDispose, shallowRef, onServerPrefetch, mergeProps, withCtx, createVNode, createTextVNode, toDisplayString as toDisplayString$1, createApp, effectScope, onErrorCaptured, resolveDynamicComponent, isReadonly, Text, resolveComponent, isShallow, isReactive, toRaw, readonly, customRef } from 'vue';
import { $ as $fetch, c as createError$1, p as hash, n as defu, q as getContext, s as createHooks, t as toRouteMatcher, v as createRouter$1, w as sanitizeStatusCode, x as getRequestHeaders, y as klona, z as parse$1, A as getRequestHeader, B as destr, C as isEqual$1, D as setCookie, E as getCookie, F as deleteCookie, G as getRequestURL } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-SsNCp4ox.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-Bnjr7SEb.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-BVtWzcxe.mjs').then((r) => r["default"] || r.default || r));
...
const resource$a = {
  ...
  "error": {
    ...
    "page404": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Page not found!" } },
    "home": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Home page" } },
    "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Oops! There's been an unexpected error" } },
    "action": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Go to documentation" } }
  },
  "update": {
    "message": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "A new version is available" } },
    "visit": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Visit on github →" } }
  }
};
const resource$9 = {
  "service": {},
  "error": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Ошибка" } },
    "page404": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Страница не найдена!" } },
    "home": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Главная страница" } },
    "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Упс! Произошла непредвиденная ошибка" } },
    "action": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Перейти к документации" } }
  },
  "update": {
    "message": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Доступна новая версия" } },
    "visit": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Перейти в github →" } }
  }
};
const resource$8 = {
  "service": {},
  "error": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "谬误" } },
    "page404": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "页面未找到!" } },
    "home": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "首页" } },
    "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "哎呀！出现意外错误" } },
    "action": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "转到文档" } }
  },
  "update": {
    "message": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "新版本问世" } },
    "visit": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "访问 github →" } }
  }
};
const resource$7 = {
  "service": {},
  "error": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "गलती" } },
    "page404": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "पृष्ठ नहीं मिला!" } },
    "home": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "होम पेज" } },
    "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "उफ़! कोई अप्रत्याशित त्रुटि हुई है" } },
    "action": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "दस्तावेज़ीकरण पर जाएँ" } }
  },
  "update": {
    "message": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "एक नया संस्करण उपलब्ध है" } },
    "visit": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "पर जाएँ github →" } }
  }
};
const resource$6 = {
  "service": {},
  "error": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Error" } },
    "page404": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Página no encontrada!" } },
    "home": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Pagina de inicio" } },
    "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "¡Uy! Se ha producido un error inesperado" } },
    "action": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Ir a la documentación" } }
  },
  "update": {
    "message": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Ya está disponible una nueva versión" } },
    "visit": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Visitar en github →" } }
  }
};
const resource$5 = {
  "service": {},
  "error": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "خطأ" } },
    "page404": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "الصفحة غير متوفرة" } },
    "home": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "الصفحة الرئيسية" } },
    "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "عفوا!! يبدو ان هنالك خطأ" } },
    "action": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "قراءة التعليمات" } }
  },
  "update": {
    "message": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "يوجد تحديث جديد" } },
    "visit": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "قم بزيارتنا على جيتهب →" } }
  }
};
const resource$4 = {
  "service": {},
  "error": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Błąd" } },
    "page404": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Strona nie istnieje!" } },
    "home": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Strona główna" } },
    "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Oops! Pojawił się nieoczekiwany błąd" } },
    "action": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Sprawdź dokumentacja" } }
  },
  "update": {
    "message": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Dostępna jest nowa wersja" } },
    "visit": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Odwiedź github →" } }
  }
};
const resource$3 = {
  "service": {},
  "error": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Erreur" } },
    "page404": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Page introuvable!" } },
    "home": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Page d'accueil" } },
    "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Oups! Une erreur inattendue s'est produite" } },
    "action": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Aller à la documentation" } }
  },
  "update": {
    "message": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Une nouvelle version est disponible" } },
    "visit": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Visitez-nous sur github →" } }
  }
};
const resource$2 = {
  "service": {},
  "error": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Fehler" } },
    "page404": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Seite nicht gefunden!" } },
    "home": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Startseite" } },
    "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Ups! Da ist ein unerwarteter Fehler aufgetreten" } },
    "action": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Gehe zur Dokumentation" } }
  },
  "update": {
    "message": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Eine neue Version ist verfügbar" } },
    "visit": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Besuch uns auf Github →" } }
  }
};
const resource$1 = {
  "service": {},
  "error": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Σφάλμα" } },
    "page404": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Η σελίδα δεν βρέθηκε!" } },
    "home": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Αρχική Σελίδα" } },
    "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Ουπς! Παρουσιάστηκε ένα απρόοπτο σφάλμα." } },
    "action": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Οδηγίες Χρήσης" } }
  },
  "update": {
    "message": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Υπάρχει μία καινούρια έκδοση!" } },
    "visit": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Δείτε στο GitHub →" } }
  }
};
const resource = {
  "service": {},
  "error": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Fout" } },
    "page404": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Pagina niet gevonden!" } },
    "home": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Startpagina" } },
    "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Oeps! Er was een onverwachte fout" } },
    "action": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Ga naar de documentatie" } }
  },
  "update": {
    "message": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Een nieuwe versie is beschikbaar" } },
    "visit": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Bekijk op Github →" } }
  }
};
const localeCodes = [
  "en",
...
const localeLoaders = {
  "en": [{ key: "../src/locales/en-US.json", load: () => Promise.resolve(resource$a), cache: true }],
  "ru": [{ key: "../src/locales/ru-RU.json", load: () => Promise.resolve(resource$9), cache: true }],
  "zh": [{ key: "../src/locales/zh-CN.json", load: () => Promise.resolve(resource$8), cache: true }],
  "hi": [{ key: "../src/locales/hi-IN.json", load: () => Promise.resolve(resource$7), cache: true }],
  "es": [{ key: "../src/locales/es-ES.json", load: () => Promise.resolve(resource$6), cache: true }],
  "ar": [{ key: "../src/locales/ar-SA.json", load: () => Promise.resolve(resource$5), cache: true }],
  "pl": [{ key: "../src/locales/pl-PL.json", load: () => Promise.resolve(resource$4), cache: true }],
  "fr": [{ key: "../src/locales/fr-FR.json", load: () => Promise.resolve(resource$3), cache: true }],
  "de": [{ key: "../src/locales/de-DE.json", load: () => Promise.resolve(resource$2), cache: true }],
  "gr": [{ key: "../src/locales/gr-GR.json", load: () => Promise.resolve(resource$1), cache: true }],
  "nl": [{ key: "../src/locales/nl-NL.json", load: () => Promise.resolve(resource), cache: true }]
};
...
const normalizedLocales = [
  {
    ...
    "files": [
      {
        "path": "/home/runner/work/dashboard/dashboard/mafl/src/locales/en-US.json"
      }
    ]
  },
  {
    ...
    "files": [
      {
        "path": "/home/runner/work/dashboard/dashboard/mafl/src/locales/ru-RU.json"
      }
    ]
  },
  {
    ...
    "files": [
      {
        "path": "/home/runner/work/dashboard/dashboard/mafl/src/locales/zh-CN.json"
      }
    ]
  },
  {
    ...
    "files": [
      {
        "path": "/home/runner/work/dashboard/dashboard/mafl/src/locales/hi-IN.json"
      }
    ]
  },
  {
    ...
    "files": [
      {
        "path": "/home/runner/work/dashboard/dashboard/mafl/src/locales/es-ES.json"
      }
    ]
  },
  {
    ...
    "files": [
      {
        "path": "/home/runner/work/dashboard/dashboard/mafl/src/locales/ar-SA.json"
      }
    ]
  },
  {
    ...
    "files": [
      {
        "path": "/home/runner/work/dashboard/dashboard/mafl/src/locales/pl-PL.json"
      }
    ]
  },
  {
    ...
    "files": [
      {
        "path": "/home/runner/work/dashboard/dashboard/mafl/src/locales/fr-FR.json"
      }
    ]
  },
  {
    ...
    "files": [
      {
        "path": "/home/runner/work/dashboard/dashboard/mafl/src/locales/de-DE.json"
      }
    ]
  },
  {
    ...
    "files": [
      {
        "path": "/home/runner/work/dashboard/dashboard/mafl/src/locales/gr-GR.json"
      }
    ]
  },
  {
    ...
    "files": [
      {
        "path": "/home/runner/work/dashboard/dashboard/mafl/src/locales/nl-NL.json"
      }
    ]
  }
];
...
function wsClient() {
  ...
  const sendHandlers = /* @__PURE__ */ new Map();
  const { status, open, close, send: _send } = useWebSocket(endpoint, {
    ...
    onMessage(_, e) {
      ...
      (_a = sendHandlers.get(event)) == null ? void 0 : _a.forEach((handler) => handler(data));
    }
  });
  const off = (event, handler) => {
    var _a;
    if (sendHandlers.has(event)) {
      (_a = sendHandlers.get(event)) == null ? void 0 : _a.delete(handler);
    }
  };
  const on = (event, handler) => {
    if (!sendHandlers.has(event)) {
      sendHandlers.set(event, /* @__PURE__ */ new Set());
    }
...
const useWebsocket = createSharedComposable(wsClient);
...
const settings_cLbEkRm6ts = /* @__PURE__ */ defineNuxtPlugin(async () => {
  let __temp, __restore;
  const { on } = useWebsocket();
  on("config:update", () => {
  });
  const asyncData = ([__temp, __restore] = executeAsync(() => useFetch("/api/settings", "$10pK9PnukF")), __temp = await __temp, __restore(), __temp);
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DVwpFpO8.mjs'))
};
  ...
  setup(__props) {
    ...
    useHead({
      ...
      htmlAttrs: {
        ...
        dir: (_b = i18nHead.value.htmlAttrs) == null ? void 0 : _b.dir
      },
      bodyAttrs: {
        class: "relative"
      }
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen flex flex-grow items-center justify-center" }, _attrs))}><div class="bg-fg/5 dark:bg-fg/10 text-fg-dimmed p-8 rounded-2xl border border-fg/10 dark:border-fg/15 w-full max-w-xl"><h1 class="mb-4 text-2xl font-light text-center">${ssrInterpolate(_ctx.$t("error.title"))} ${ssrInterpolate(_ctx.error.statusCode)}</h1><div class="text-sm">`);
      if (_ctx.error.statusCode === 404) {
        _push(`<!--[--><p class="text-center">${ssrInterpolate(_ctx.$t("error.page404"))}</p><p class="text-center mt-4">`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/",
          class: "text-brand-600 hover:text-brand-800 transition-all"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(_ctx.$t("error.home"))}`);
            } else {
              return [
                createTextVNode(toDisplayString$1(_ctx.$t("error.home")), 1)
              ];
            }
          }),
          _: 1
        ...
        _push(`<!--[--><p class="text-center">${ssrInterpolate(_ctx.$t("error.description"))}</p><p class="text-center mt-2"><a href="https://mafl.hywax.space/" class="text-brand-600 hover:text-brand-800 transition-all">${ssrInterpolate(_ctx.$t("error.action"))} →</a></p>`);
        if ((_a = _ctx.error) == null ? void 0 : _a.message) {
          _push(`<pre class="mt-6 bg-fg/5 dark:bg-fg/10 text-fg-dimmed px-3 py-2 rounded-2xl border border-fg/10 dark:border-fg/15 max-h-52 overflow-auto"><code>${ssrInterpolate(_ctx.error.message)}</code></pre>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--]-->`);
...
export { useIntervalFn as a, useNuxtApp as b, createError as c, useState as d, entry$1 as default, useFetch as u };
